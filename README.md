...
A SystemVerilog CORDIC engine that calculates fixed-point sine and cosine using shifts, additions, and subtractions. The engine performs 14 iterations and supports 16 predefined angles from 0° to 90°.

This project is based on the [Verilog Meetup](https://verilog-meetup.com) Tiny Tapeout template and uses the [Basics Graphics Music](https://github.com/yuri-panchul/basics-graphics-music) `lab_top` interface.

The first push button starts a calculation. The selected angle and calculated sine are shown in hexadecimal format on the TM1638 eight-digit display.
